...
select top(10) * from FCRMVH where FCRMVH_MODFOR = 'FC' and FCRMVH_CODFOR = 'PREVEN' order by FCRMVH_NROFOR desc
...
and STTPRE_ARTCOD = 'HCA3025P' 
--AND STTPRE_CODLIS = 'LPMIMO0001'
--and STTPRE_OLDUID = 'ADMIN'
and P.STMPDH_TIPPRO like 'MIPR30'
--and p.STMPDH_INDCOD = '2'
order by l.STTPRE_FECLIS desc

	select distinct STTPRE_ARTCOD,* from STTPRE where STTPRE_ARTCOD = 'HCA3025P' 
