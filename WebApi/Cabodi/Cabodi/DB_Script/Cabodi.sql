...
UPDATE VTMCLH SET USR_VTMCLH_CONAPP = 'brv6xdhzC09knMs1shM4V0MUVbzLMI3mSKKbcEo8fXYHHeaHJcUF17LPGmr+PHc1l+Y0XpGL8hVupIYkrSezmWnJkbJ7' 
WHERE LEFT(VTMCLH_NROCTA,2) = 'ZI'


SELECT * from VTMCLH-- SET USR_VTMCLH_CONAPP = 'EG+Vl+Cy6owb1Tm1UHYJIZgOYePv/B8kauOdzCQFv8LzSkSUDvhLg3wj1BnP0Ha9FsZ5eghKVMCVmmmu2ji+0IjznNA=' 
WHERE LEFT(VTMCLH_NROCTA,2) = 'ZI'
...
select VTMCLH_MODCPT,* from VTMCLH where LEFT(VTMCLH_NROCTA,6) = 'VH6136'
/*Vendedores*/
...
select top(1000) FCRMVH_ULTOPR,FCRMVH_DEBAJA,FCRMVH_OALIAS,fcrmvh_fecalt,fcrmvh_fecmod,* from FCRMVH where FCRMVH_MODFOR = 'FC' and FCRMVH_CODFOR = 'PREVEN' and FCRMVH_NROFOR = 92212 order by FCRMVH_NROFOR desc
	--FCRMVH_USERID = 'ZI0026' order by FCRMVH_NROFOR desc
select top(10) * from FCRMVI where FCRMVI_MODFOR = 'FC' 
and FCRMVI_CODFOR = 'PREVEN' order by FCRMVI_NROFOR desc
/*Productos*/
select STMPDH_CUENPV,STMPDH_CUENVT, STMPDH_FACALT,STMPDH_INDCOD, STMPDH_UNICON, * from STMPDH where STMPDH_TIPPRO = 'MIPR30'  and STMPDH_ARTCOD = 'HCA3025P' order by 1
/*Tipo Productos*/
select * from STTTPH
...
and STTPRE_ARTCOD = 'ADISB10P' 
--AND STTPRE_CODLIS = 'LPMIMO0001'
--and STTPRE_OLDUID = 'ADMIN'
and P.STMPDH_TIPPRO like 'MIPRAD'
--and p.STMPDH_INDCOD = '2'
order by l.STTPRE_FECLIS desc

	select distinct STTPRE_ARTCOD,* from STTPRE where STTPRE_ARTCOD = 'HELPI50P' 
...
select * from STMPDH-- order by 3 desc--VTRMVH--VTTVND
where STMPDH_ARTCOD like '%HCA3025P%'